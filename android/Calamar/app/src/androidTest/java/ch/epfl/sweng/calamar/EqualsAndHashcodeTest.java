...
public class EqualsAndHashcodeTest {
    ...
    public void testSimpleTextItem() {
        helperVerifyEqualsAndHashcode(new SimpleTextItem(12, new User(13, "bob"), new User(14, "sponge"), new Date(1000), Condition.trueCondition(), "Heeeeyyyyy"),
    ...
    public void testImageItem() {
        ...
        assertTrue(BitmapFactory.decodeByteArray(bytes, 0, bytes.length).sameAs(BitmapFactory.decodeByteArray(bytes, 0, bytes.length)));
        helperVerifyEqualsAndHashcode(new ImageItem(12, new User(13, "bob"), new User(14, "sponge"), new Date(1000), Condition.trueCondition(), BitmapFactory.decodeByteArray(bytes, 0, bytes.length)),
